...
Today I continued integrating [D3 with Vue](https://github.com/chrisvaillancourt/vue-d3).

#### Thoughts

My head was all over the place so I know this code is far from acceptable but it works and I'm starting to get a better understanding of what goes where. The one issue I'm facing is properly positioning the tooltip. I wish there were more examples of using D3 with Vue but I've found Shirley's [example](https://github.com/sxywu/vue-d3-example) invaluable.
